...
if (!empty($_REQUEST['instrument']) && !empty($_REQUEST['note'])):
  ...
  <footer>
    ...
    <p>Disclaimer: this is a quick proof-of-concept for a much better tool. Very early preview of future version available <a href="https://harmonics.ligetiquartet.com">here</a> (subject to significant changes).</p>
